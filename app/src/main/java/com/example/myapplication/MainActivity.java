        ...
        MatchDatabase.getInstance().listenChangedMoveMatch(curMatch.getID(), new EventAfterListen() {
            ...
            public void getObjectAfterEvent(Object o) {
                ...
                if(match.getMove() != null) {
                    ...
                    if (move.isX()) {
                        chessBoard[move.getPosY()][move.getPosX()] = 66;//66 đại diện cho x
                        ...
                        chessBoard[move.getPosY()][move.getPosX()] = 88;//66 đại diện cho x
...
//                    isXplayer=!isXplayer;
                    ...
                    Toast.makeText(MainActivity.this,"Chưa đến lượt của bạn!",Toast.LENGTH_SHORT).show();
                    return;
                }
                oDaDanh++;
